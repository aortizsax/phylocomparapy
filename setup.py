...
project_init = _read(["src", "phylocomparapy", "__init__.py"])
...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "phylocomparapy = phylocomparapy.application.phylocomparapy:main",
        ]
    },
    ...
    package_data={
        ...
        "phylocomparapy": [
            ...
            # For files located in 'src/phylocomparapy-data/'
            # "../phylocomparapy-data/*.json",
            # For files located in 'resources'/'
            # "../../resources/*.json",
        ],
    },
    test_suite = "tests",
    # url="http://pypi.python.org/pypi/phylocomparapy",
    url="https://github.com/aortizsax/phylocomparapy",
    license="LICENSE",
